...
// pub fn rel(c: color, step: Duration) -> NormStrokes {
//     let mut left_eye = NormStroke::default();
//     left_eye.set_points_and_pressure(&[
//         (
//             (0.8312877, 0.056030896).into(),
//             0.030182345,
//             (0.99696344, 0.05035477).into(),
//         ),
//         (
//             (0.8311606, 0.056113575).into(),
//             0.0330663,
//             (0.99696344, 0.05035477).into(),
//         ),
//         (
//             (0.83109695, 0.056196254).into(),
//             0.037506677,
//             (0.99696344, 0.05035477).into(),
//         ),
//         (
...
//         ),
//         (
//             (0.83135134, 0.056113575).into(),
//             0.03698787,
//             (0.99696344, 0.05035477).into(),
//         ),
//         (
//             (0.83160573, 0.056196254).into(),
//             0.034424353,
//             (0.99696344, 0.05035477).into(),
//         ),
//         (
//             (0.832178, 0.056278937).into(),
//             0.030960556,
//             (0.99696344, 0.05035477).into(),
//         ),
//         (
//             (0.83281404, 0.056526918).into(),
//             0.02607767,
//             (0.99696344, 0.05035477).into(),
//         ),
//         (
//             (0.8334499, 0.05669228).into(),
//             0.022735942,
//             (0.99696344, 0.05035477).into(),
//         ),
//         (
//             (0.834213, 0.05677496).into(),
//             0.02198825,
//             (0.99696344, 0.05035477).into(),
//         ),
//         (
//             (0.83472174, 0.057436287).into(),
//             0.013977264,
//             (0.99696344, 0.05035477).into(),
//         ),
//         (
//             (0.83548486, 0.057518966).into(),
//             0.00015259022,
//             (0.99696344, 0.05035477).into(),
//         ),
//     ]);

//     let mut right_eye = NormStroke::default();
//     right_eye.set_points_and_pressure(&[
//         (
//             (0.84305245, 0.05942038).into(),
//             0.021881437,
//             (0, 0.044251163).into(),
//         ),
//         (
//             (0.84317964, 0.0593377).into(),
//             0.022919051,
//             (0, 0.044251163).into(),
//         ),
//         (
//             (0.84343404, 0.059007037).into(),
//             0.026581217,
//             (0, 0.044251163).into(),
//         ),
//         (
//             (0.84343404, 0.058841676).into(),
//             0.032242313,
//             (0, 0.044251163).into(),
//         ),
//         (
//             (0.84343404, 0.058758996).into(),
//             0.03665217,
//             (0, 0.044251163).into(),
//         ),
//         (
//             (0.8434976, 0.058676373).into(),
//             0.03881895,
//             (0, 0.044251163).into(),
//         ),
//         (
//             (0.8435612, 0.058593694).into(),
//             0.039810788,
//             (0, 0.044251163).into(),
//         ),
//         (
//             (0.8435612, 0.058511015).into(),
//             0.040283818,
//             (0, 0.044251163).into(),
//         ),
//         (
//             (0.8436248, 0.058345653).into(),
//             0.04043641,
//             (0, 0.044251163).into(),
//         ),
//         (
//             (0.843752, 0.058262974).into(),
//             0.0402533,
//             (0, 0.044251163).into(),
//         ),
//         (
//             (0.84394276, 0.05818035).into(),
//             0.039658196,
//             (0, 0.044251163).into(),
//         ),
//         (
//             (0.84406996, 0.05801499).into(),
//             0.038635843,
//             (0, 0.044251163).into(),
//         ),
//         (
//             (0.8443243, 0.05793231).into(),
//             0.03666743,
//             (0, 0.044251163).into(),
//         ),
//         (
//             (0.8446422, 0.057684325).into(),
//             0.032242313,
//             (0, 0.044251163).into(),
//         ),
//         (
//             (0.8450238, 0.057518966).into(),
//             0.025680933,
//             (0, 0.044251163).into(),
//         ),
//         (
//             (0.8445787, 0.058345653).into(),
//             0.018753339,
//             (0, 0.044251163).into(),
//         ),
//         (
//             (0.8450874, 0.058262974).into(),
//             0.00010681315,
//             (0, 0.044251163).into(),
//         ),
//     ]);

//     let mut smile = NormStroke::default();
//     smile.set_points_and_pressure(&[
//         (
//             (0.83052456, 0.068596676).into(),
//             0.01980621,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.8305882, 0.06851406).into(),
//             0.02059968,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.83065176, 0.06834869).into(),
//             0.021194782,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.83065176, 0.06826601).into(),
//             0.021454185,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.8305882, 0.06801803).into(),
//             0.021622034,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.8305882, 0.06793535).into(),
//             0.021820402,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
...
//         ),
//         (
//             (0.83052456, 0.06793535).into(),
//             0.022842756,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.830461, 0.06801803).into(),
//             0.0240177,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
...
//         ),
//         (
//             (0.830461, 0.06810065).into(),
//             0.028046083,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.8303975, 0.06810065).into(),
//             0.030045014,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.8303338, 0.06826601).into(),
//             0.03106737,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.8302703, 0.06851406).into(),
//             0.031311512,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.8301431, 0.068679355).into(),
//             0.03137255,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.83007944, 0.0689274).into(),
//             0.031448845,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.8300159, 0.069258064).into(),
//             0.031448845,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.8300159, 0.06958873).into(),
//             0.031296253,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.8299523, 0.069919385).into(),
//             0.031021591,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.8298887, 0.07033273).into(),
//             0.030762188,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.8298887, 0.07066345).into(),
//             0.03059434,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.8299523, 0.07099412).into(),
//             0.030502785,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.8299523, 0.0712421).into(),
//             0.03042649,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.83007944, 0.07149014).into(),
//             0.030457009,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.83020663, 0.0718208).into(),
//             0.030395972,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.8302703, 0.07198616).into(),
//             0.030243382,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.830461, 0.07223415).into(),
//             0.030334936,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.83065176, 0.07256481).into(),
//             0.030762188,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.83096975, 0.07297821).into(),
//             0.031311512,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.8315421, 0.073474176).into(),
//             0.0317998,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.83198726, 0.07388758).into(),
//             0.032181278,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.832496, 0.07421824).into(),
//             0.032410163,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.8329411, 0.07454891).into(),
//             0.032501716,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.8335135, 0.074796885).into(),
//             0.032425422,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.8341494, 0.07496225).into(),
//             0.03225757,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.83472174, 0.07504493).into(),
//             0.032196537,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.8354213, 0.07512761).into(),
//             0.032227054,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.83618444, 0.07504493).into(),
//             0.03216602,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.8370111, 0.074796885).into(),
//             0.03198291,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.8378379, 0.07446623).into(),
//             0.0318761,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.83866453, 0.07405288).into(),
//             0.0317998,
//             (0.0030518044, 0.053406578).into(),
//         ),
//         (
//             (0.83949125, 0.073556855).into(),
//             0.032028686,
//             (0.0030518044, 0.05035477).into(),
//         ),
//         (
//             (0.84031796, 0.07289553).into(),
//             0.032364387,
//             (0.0030518044, 0.05035477).into(),
//         ),
//         (
//             (0.8410811, 0.07215147).into(),
//             0.03262379,
//             (0.0030518044, 0.05035477).into(),
//         ),
//         (
//             (0.8417806, 0.07149014).into(),
//             0.032791637,
//             (0.0030518044, 0.05035477).into(),
//         ),
//         (
//             (0.84248006, 0.07074613).into(),
//             0.033005264,
//             (0.0030518044, 0.05035477).into(),
//         ),
//         (
//             (0.84330684, 0.07000207).into(),
//             0.033310443,
//             (0.0030518044, 0.05035477).into(),
//         ),
//         (
//             (0.84381557, 0.06934074).into(),
//             0.033630885,
//             (0.0030518044, 0.05035477).into(),
//         ),
//         (
//             (0.8441335, 0.06884472).into(),
//             0.033951323,
//             (0.0030518044, 0.05035477).into(),
//         ),
//         (
//             (0.8445151, 0.06834869).into(),
//             0.033936065,
//             (0.0030518044, 0.05035477).into(),
//         ),
//         (
//             (0.8447059, 0.06793535).into(),
//             0.03389029,
//             (0.0030518044, 0.05035477).into(),
//         ),
//         (
//             (0.8448331, 0.06768731).into(),
//             0.034027617,
//             (0.0030518044, 0.05035477).into(),
//         ),
//         (
//             (0.8449603, 0.06760468).into(),
//             0.034225985,
//             (0.0030518044, 0.05035477).into(),
//         ),
//         (
//             (0.8449603, 0.067439325).into(),
//             0.034592204,
//             (0.0030518044, 0.05035477).into(),
//         ),
//         (
//             (0.8449603, 0.06727397).into(),
//             0.03523308,
//             (0.0030518044, 0.05035477).into(),
//         ),
//         (
//             (0.8448966, 0.06710866).into(),
//             0.035751887,
//             (0.0030518044, 0.05035477).into(),
//         ),
//         (
//             (0.8448966, 0.06686062).into(),
//             0.035980772,
//             (0.0030518044, 0.05035477).into(),
//         ),
//         (
//             (0.8448966, 0.06652996).into(),
//             0.035934996,
//             (0.0030518044, 0.05035477).into(),
//         ),
//         (
//             (0.8448331, 0.066199295).into(),
//             0.03541619,
//             (0.0030518044, 0.05035477).into(),
//         ),
//         (
//             (0.8448331, 0.06586858).into(),
//             0.034241244,
//             (0.0030518044, 0.04882887).into(),
//         ),
//         (
//             (0.8448331, 0.06570327).into(),
//             0.032074463,
//             (0.0030518044, 0.04882887).into(),
//         ),
//         (
//             (0.8448331, 0.065620594).into(),
//             0.028381782,
//             (0.0030518044, 0.04882887).into(),
//         ),
//         (
//             (0.8447694, 0.065620594).into(),
//             0.024231328,
//             (0.0030518044, 0.04882887).into(),
//         ),
//         (
//             (0.8447059, 0.06570327).into(),
//             0.022034029,
//             (0.0030518044, 0.04882887).into(),
//         ),
//         (
//             (0.8453418, 0.065041885).into(),
//             0.0039368276,
//             (0.0030518044, 0.04882887).into(),
//         ),
//     ]);
